...
/**
 * This is used to pass around and manipulate one queue entry. The methods are
 * persistence agnostic, with the details hidden within the implementation of
 * the referenced PhineasQ. The values are coordinated with the queue XML
 * definition, not necessarily the definition within the backing store.
 * <p>
...
public class PhineasQRow {
	 ...
	 * 
	 * @return true if successful
	 * @see tdunnick.jphineas.queue.PhineasQConnection#remove(tdunnick.jphineas.queue.PhineasQ,
	 *      int)
	 */
